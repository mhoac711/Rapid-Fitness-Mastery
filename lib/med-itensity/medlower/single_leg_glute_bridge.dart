...
class SingleLegGluteBridge extends StatelessWidget {
  final Exercise e;
  const SingleLegGluteBridge({Key? key, required this.e}) : super(key: key);
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Image.asset(
                      'assets/images/singLegGluteBridge.gif',
                      height: 250,
                      width: 350,
                      scale: 50,
                      fit: BoxFit.fill,
